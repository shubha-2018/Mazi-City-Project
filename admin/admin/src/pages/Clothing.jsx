...
function Clothing() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log(err);
      setError("Failed to load clothing");
      setLoading(false);
    }
  };
  ...
  return (
    <AdminLayout>
      <div className="responsive-header" style={styles.responsiveHeader}>
        <h3 style={styles.title}>Clothing</h3>
        <button
          className="btn btn-primary"
          style={styles.addButton}
          onClick={() => navigate("/clothing/add")}
        >
          <span style={{ marginRight: "5px" }}>+</span> Add Clothing
        </button>
      </div>
                      ...
                      {clothing.length === 0 ? (
                        <tr>
                          <td colSpan="11" className="text-center py-4">
                            <p style={styles.emptyText}>No Clothing Found</p>
                          </td>
                        </tr>
                      ) : (
