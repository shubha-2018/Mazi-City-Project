...
function Groceries() {
  ...
  const getFilteredData = () => {
    if (!selectedCity) return groceries;
    return groceries.filter(item => item.location === selectedCity);
  };
  ...
  return (
    <AdminLayout>
      ...
      <div className="responsive-header" style={styles.responsiveHeader}>
        <h3 style={styles.title}>Groceries</h3>
        <button
          className="btn btn-primary"
          style={styles.addButton}
          onClick={() => navigate("/groceries/add")}
        >
          <span style={{ marginRight: "5px" }}>+</span> Add Grocery
        </button>
      </div>

      {/* Filter */}
      <div className="mb-3" style={styles.filterSection}>
                      ...
                      {getFilteredData().length === 0 ? (
                        <tr>
                          <td colSpan="11" className="text-center py-4">
                            <p style={styles.emptyText}>No Grocery Items Found</p>
                          </td>
                        </tr>
                      ) : (
                          ...
                          <tr key={item.id}>
                            ...
                            <td style={styles.actionCell}>
                              <button
                                ...
                                onClick={() => navigate(`/groceries/edit/${item.id}`)}
                              >
                                Edit
                              </button>
                              <button
