  ...
  useEffect(() => {
    ...
    const fetchItem = async () => {
      try {
        ...
        alert("Electronics item not found");
    ...
    <AdminLayout>
      <div className="card shadow">
        <div className="card-header bg-primary text-white">
          <h3>{isEditMode ? "Edit Electronics" : "Add Electronics"}</h3>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                placeholder="e.g., Modern Electronics Store"
                required
              />
            </div>
            ...
            <div className="d-flex gap-2">
              <button type="submit" className="btn btn-success">
                {isEditMode ? "Update Electronics" : "Add Electronics"}
              </button>
              <button
                type="button"
